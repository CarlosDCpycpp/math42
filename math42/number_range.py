...
from ._bases.infinity_bases import InfinityBases as _InfinityBases
...
class NumberRange:
    ...
    @property
    def length(self) -> int | _InfinityBases:
    ...
    @property
    def finish(self):
        return None if isinstance(self.max, _InfinityBases) else self.max
